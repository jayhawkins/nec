...
<html>
<head>
    <title>NEC - Forgot Password</title>
            ...
            <div class="col-xl-4 col-md-6 col-xs-10 col-xl-offset-4 col-md-offset-3 col-xs-offset-1">
                ...
                <section class="widget widget-login animated fadeInUp">
                    ...
                    <div class="widget-body">
                        ...
                        <form id="formLogin" class="login-form mt-lg" method="POST" action="/forgot" onsubmit="return verifyInput();">
                            <div class="form-group">
                                <input type="text" class="form-control" id="username" name="username" placeholder="Email" required="required" data-parsley-type="email" />
                            </div>
<?php
                            if (!empty($invalidUsername)) {
                                echo "<div class=\"alert alert-danger\" role=\"alert\">". $invalidUsername . "</div>";
                            }
 ?>
                            <div class="clearfix">
                                <div class="btn-toolbar pull-xs-right">
                                    <a class="btn btn-secondary btn-sm" href="/login">Back</a>
                                    <input type="submit" name="login" class="btn btn-inverse btn-sm" value="Reset" />
                                </div>
                            </div>
                            <div class="row">
