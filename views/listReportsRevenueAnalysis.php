...
require '../lib/common.php';
 ...
 <script>
      ...
      function loadTableAJAX() {
        ...
        url = '<?php echo HTTP_HOST."/getrevenueanalysis" ?>';
        ...
        var example_table = $('#datatable-table').DataTable({
            ...
            columns: [
                ...
                { data: "totalRevenue", render: $.fn.dataTable.render.number(',', '.', 2, '$') }
            ]
          });
 ...
 <section class="widget">
     <header>
         <h4><span class="fw-semi-bold">Revenue Analysis</span></h4>
         ...
         <div id="dataTable" class="mt">
             <table id="datatable-table" class="table table-striped table-hover" width="100%">
                 ...
                 <tr>
                     ...
                     <th class="hidden-sm-down">Potential Sales</th>
                     <th class="hidden-sm-down">Actual Sales</th>
                     <th class="hidden-sm-down text-nowrap">Repairs</th>
                     <th class="hidden-sm-down">Total Revenue</th>
                 </tr>
                 </thead>
                 <tbody>
