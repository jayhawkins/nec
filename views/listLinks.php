...
require '../lib/common.php';
 ...
 <section class="widget">
     ...
     <div class="widget-body">
         ...
         <button type="button" id="addContact" class="btn btn-primary pull-xs-right" data-target="#myModal">Add Link</button>
         <br /><br />
   ...
   <div class="modal-dialog modal-lg" role="document">
     <div class="modal-content">
       <div class="modal-header">
         <h5 class="modal-title" id="exampleModalLabel"><strong>Edit Link</strong></h5>
