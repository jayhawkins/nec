                ...
                columns: [
                    ...
                    { data: "notes" },
                    {
                        ...
                        "mRender": function (podDataJSON) {
                            ...
                            if(errorCount > 0){
                                buttons = '<button type="button" class="btn btn-primary btn-xs" onclick="alert(\'' + errorMessage + '\')"><i class="fa fa-download text"></i> <span class="text">Download POD</span></button>';
