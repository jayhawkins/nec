...
//----------------------------------------------------------------------------
            // Insert insurance_carrier data
            $insuranceurl = API_HOST_URL . '/insurance_carriers';
            $insurancedata = array(
                        "entityID" => $entityresult,
                        "name" => $row['Insurance_Company'],
                        "contactName" => $row['Insurance_Contact'],
                        "contactEmail" => '',
                        "contactPhone" => $row['Insurance_Phone'],
                        "policyNumber" => '',
                        "policyExpirationDate" => $row['Insurance_Expiration_Date'],
                        "fileupload" => '',
                        "status" => 'Active',
                        "createdAt" => date('Y-m-d H:i:s'),
                        "updatedAt" => date('Y-m-d H:i:s')
            ...
            $insuranceoptions = array(
                'http' => array(
                    'header'  => "Content-type: application/x-www-form-urlencoded\r\n",
                    'method'  => 'POST',
                    'content' => http_build_query($insurancedata)
                )
            );
            $insurancecontext  = stream_context_create($insuranceoptions);
            $insuranceresult = file_get_contents($insuranceurl, false, $insurancecontext);
//----------------------------------------------------------------------------
