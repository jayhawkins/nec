...
// Strip off the '/api' so we have the true path for the class - otherwise will not work
$pos = strpos($_SERVER['PATH_INFO'],"/api");
$newstring = substr($_SERVER['PATH_INFO'],$pos+4);
$_SERVER['PATH_INFO'] = $newstring;
